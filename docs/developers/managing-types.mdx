...
You can also define types **outside** the Flowsint repository and have them auto-discovered through an entry point — useful for private or domain-specific packs versioned on their own. See [External packs (plugins)](/docs/developers/external-packs).
