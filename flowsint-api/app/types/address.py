...
class PhysicalAddress(BaseModel):
    ...
    latitude: Optional[float] = Field(None, description="Latitude coordinate of the address", title="Latitude")
    longitude: Optional[float] = Field(None, description="Longitude coordinate of the address", title="Longitude")
