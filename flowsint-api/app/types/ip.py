...
class Ip(BaseModel):
    ...
    country: Optional[str] = Field(None, description="Country where the IP is located", title="Country")
    city: Optional[str] = Field(None, description="City where the IP is located", title="City")
    isp: Optional[str] = Field(None, description="Internet Service Provider", title="ISP")
