...
from tests.fixtures.database import (
    test_db_session, test_owner_id, test_profile, test_api_key, 
    test_vault, test_vault_with_multiple_keys, multiple_test_keys,
...
class TestVaultIntegration:
    ...
    def test_vault_get_secret_by_uuid(self, test_vault_with_multiple_keys, multiple_test_keys):
...
class TestCryptoWalletAddressToTransactions:
    ...
    @pytest.mark.asyncio
    async def test_async_init_with_vault_key_exists(self, test_vault_with_multiple_keys, test_sketch_scan_ids):
    ...
    @pytest.mark.asyncio
    async def test_async_init_with_vault_key_not_exists(self, test_vault, test_sketch_scan_ids):
...
class TestCryptoWalletAddressToNFTs:
    ...
    @pytest.mark.asyncio
    async def test_async_init_with_vault_multiple_keys(self, test_vault_with_multiple_keys, test_sketch_scan_ids):
...
class TestBothCryptoScannersIntegration:
    ...
    @pytest.mark.asyncio
    async def test_multiple_scanners_same_vault(self, test_vault_with_multiple_keys, test_sketch_scan_ids):
    ...
    @pytest.mark.asyncio
    async def test_multiple_scanners_different_keys(self, test_vault_with_multiple_keys, test_sketch_scan_ids):
    ...
    def test_scanner_schemas_consistency(self):
        ...
        transactions_api_key = next(
            (param for param in transactions_params if param["name"] == "ETHERSCAN_API_KEY"), 
            None
        )
        nfts_api_key = next(
