                                ...
                                {investigation.sketches && investigation.sketches.length > 0 ? (
                                    <ul className="py-2 border-l">
                                        {investigation.sketches.map((sketch: Sketch) => (
                                            <li key={sketch.id} className={cn("pr-2 pl-6 text-muted-foreground hover:text-foreground hover:bg-muted/50 border-l-2 border-l-transparent", activeTabId === sketch.id && "border-l-primary bg-muted text-foreground")}>
                                                <button
                                                    onClick={() => {
                                                        setActiveTab(sketch.id)
                                                    }}
