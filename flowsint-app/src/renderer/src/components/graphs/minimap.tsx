...
const Minimap = ({
    ...
    return (
        <div style={{ width: width, height: height }} className='absolute bottom-3 right-3 bg-background/90 backdrop-blur-sm overflow-hidden border border-border rounded-lg'>
            <svg
                width={width}
                height={height}
