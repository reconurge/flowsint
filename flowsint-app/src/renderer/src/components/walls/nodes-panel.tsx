...
const NodesPanel = memo(({ nodes, isLoading }: { nodes: NodeData[]; isLoading?: boolean }) => {
    const setCurrentNode = useWallStore((state) => state.setCurrentNode)
    const setSelectedNodes = useWallStore((state) => state.setSelectedNodes)
    const selectedNodes = useWallStore((state) => state.selectedNodes || [])
