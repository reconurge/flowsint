...
@flowsint_enricher
class DomainToDummyIp2Enricher(Enricher):
    """
...
InputType = DomainToDummyIp2Enricher.InputType
OutputType = DomainToDummyIp2Enricher.OutputType
