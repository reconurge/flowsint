from flowsint_enrichers.domains.subdomains import SubdomainEnricher
from flowsint_types.domain import Domain, Domain

enricher = SubdomainEnricher("sketch_123", "scan_123")
...
def test_scan_extracts_subdomains(monkeypatch):
    ...
    # Patch la requête réseau dans le module enricher
    monkeypatch.setattr("requests.get", mock_get)

    input_data = [Domain(domain="example.com")]
    domains = enricher.execute(input_data)
