...
from flowsint_enrichers.emails.to_gravatar import EmailToGravatarEnricher
from flowsint_types.email import Email
from flowsint_types.gravatar import Gravatar

enricher = EmailToGravatarEnricher("sketch_123", "scan_123")


class TestEmailToGravatarEnricher:
    """Test suite for EmailToGravatarEnricher"""

    def test_name(self):
        """Test the enricher name"""
        assert EmailToGravatarEnricher.name() == "to_gravatar"

    def test_category(self):
        """Test the enricher category"""
        assert EmailToGravatarEnricher.category() == "Email"

    def test_key(self):
        """Test the enricher key"""
        assert EmailToGravatarEnricher.key() == "email"

    def test_input_schema(self):
        """Test the input schema generation"""
        schema = EmailToGravatarEnricher.input_schema()
    ...
    def test_output_schema(self):
        ...
        schema = EmailToGravatarEnricher.output_schema()
    ...
    def test_preprocess_string_emails(self):
        ...
        result = enricher.preprocess(emails)
        assert len(result) == 2
    ...
    def test_postprocess_with_neo4j_connection(self):
        ...
        mock_neo4j = Mock()
        enricher_with_neo4j = EmailToGravatarEnricher(
        ...
        result = enricher_with_neo4j.postprocess(gravatars, original_input)
    ...
    def test_postprocess_without_neo4j_connection(self):
        ...
        result = enricher.postprocess(gravatars, original_input)
    ...
    def test_postprocess_none_original_input(self):
        ...
        result = enricher.postprocess(gravatars, [])
    ...
    def test_execute_full_workflow(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            result = enricher.execute(emails)
    ...
    def test_execute_with_invalid_input(self):
        ...
        with patch("requests.get") as mock_get:
            ...
            # The enricher processes any string as an email, so it will create Email objects
