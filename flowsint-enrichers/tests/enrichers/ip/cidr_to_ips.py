from flowsint_enrichers.ips.cidr_to_ips import CidrToIpsEnricher
from flowsint_types.cidr import CIDR
from flowsint_types.ip import Ip
from tests.logger import TestLogger

logger = TestLogger()
enricher = CidrToIpsEnricher("sketch_123", "scan_123", logger)
...
def test_preprocess_valid_cidrs():
    ...
    result = enricher.preprocess(cidrs)
