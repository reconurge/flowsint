from flowsint_enrichers.ips.geolocation import IpToInfosEnricher
from flowsint_types.ip import Ip, Ip

enricher = IpToInfosEnricher("sketch_123", "scan_123")
...
def test_scan_returns_ip(monkeypatch):
    ...
    monkeypatch.setattr(enricher, "get_location_data", mock_get_location_data)

    input_data = [Ip(address="8.8.8.8")]
    output = enricher.execute(input_data)
