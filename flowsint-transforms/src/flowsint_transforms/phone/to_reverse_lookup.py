...
from tools.socials.epieos import EpieosTool
from dotenv import load_dotenv

load_dotenv()


class PhoneToReverseLookupTransform(Transform):
    """[EPIEOS] Takes a phone number and performs a reverse lookup on associated social accounts."""
        ...
        return [
            {
                "name": "EPIEOS_API_KEY",
                "type": "vaultSecret",
                "description": "The Epieos API key to use for reverse lookups.",
                "required": True,
            },
        ]
    ...
    @classmethod
    def name(cls) -> str:
        return "phone_to_reverse_lookup"
