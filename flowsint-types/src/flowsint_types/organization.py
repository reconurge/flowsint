...
class Organization(BaseModel):
    ...
    sigle: Optional[str] = Field(None, description="Acronym", title="Acronym")
    ...
    activite_principale: Optional[str] = Field(
        None, description="Main activity code", title="Main Activity Code"
    )
    section_activite_principale: Optional[str] = Field(
    ...
    siege_etat_administratif: Optional[str] = Field(
        None,
        description="Siege administrative status",
        title="Headquarters Administrative Status",
    )
    ...
    complements_collectivite_territoriale: Optional[str] = Field(
        None,
    ...
    complements_liste_idcc: Optional[List[str]] = Field(
    ...
    complements_liste_id_organisme_formation: Optional[List[str]] = Field(
        None,
    ...
    complements_identifiant_association: Optional[str] = Field(
        None,
        description="Complements association identifier",
        title="Association Identifier",
    )
    complements_statut_entrepreneur_spectacle: Optional[str] = Field(
        None,
        description="Complements show entrepreneur status",
        title="Show Entrepreneur Status",
    )
    complements_type_siae: Optional[str] = Field(
