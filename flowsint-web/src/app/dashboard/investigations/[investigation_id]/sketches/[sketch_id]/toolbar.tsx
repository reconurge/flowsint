    ...
    return (
        <div className="flex items-center justify-between h-10 border-b px-2 bg-card">
            <div className="flex items-center space-x-1">
                <TooltipProvider>
                    <ToolbarButton icon={<Undo className="h-4 w-4 opacity-70" />} tooltip="Undo" />
                    <ToolbarButton icon={<Redo className="h-4 w-4 opacity-70" />} tooltip="Redo" />
                    <Separator />
                    <ToolbarButton
                    ...
                    />
                    <Separator />
                    <ToolbarButton icon={<ArrowDownUp className="h-4 w-4 opacity-70" />} tooltip="Arrange" />
                    <ToolbarButton icon={<Filter className="h-4 w-4 opacity-70" />} tooltip="Filter" />
                    <Separator />
                    <ToolbarButton
