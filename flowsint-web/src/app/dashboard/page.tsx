...
import { FolderLockIcon, MoreHorizontal, PlusIcon, RotateCwIcon, Search } from "lucide-react"
...
const DashboardPage = () => {
    ...
    const { data: investigations, isLoading, refetch, isRefetching } = useQuery({
        queryKey: [process.env.NEXT_PUBLIC_DOCKER_FLOWSINT_API, "dashboard", "investigations"],
        queryFn: async () => {
